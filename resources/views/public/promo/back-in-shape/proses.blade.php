<x-main specialPage=true>
  ...
  <x-layout_card_form>
    <div class="p-4">
      <h3>Hallo {{ $dataReq->nama }}</h3>
      <p>Terimakasih banyak atas pemesanannya, data pemesanan {{ $dataReq->nama }} sudah kami terima.</p>
      <p>invoice kak {{ $dataReq->nama }} Sudah kami kirimkan ke email. Mohon untuk menyelesaikan transaksi segera.</p>
      ...
      <table class="w-full my-4">
        ...
        <tbody class="leading-relaxed">
          <tr>
            ...
            <td class="">: {{ $dataReq->nama }}</td>
          </tr>
          <tr>
            <td class="">Email Pemesan</td>
            <td class="">: {{ $dataReq->email }}</td>
          </tr>
          <tr>
            <td class="">Kode Invoice</td>
            <td class="">: {{ $dataReq->kode }}</td>
          </tr>
        </tbody>
      </table>
