<x-main specialPage=true>
  ...
  @endpush
  <div class="2xl:container font-FuturaBold relative">
    <div class="w-full aspect-auto bg-[url('/image/promo/288/bgHeader.png')] bg-cover relative -z-0">
      <div class="w-24 lg:w-36 lg:ml-12 lg:pt-4">
        <img class="w-full" src="{{ url('/image/Logo_Urban-2.png')}}" alt="Logo Urban Athletes">
      </div>
      <div class="container grid md:grid-cols-2 items-center min-h-[30rem] lg:min-h-[40rem]">
        <div class="my-8 mx-4 lg:ml-4 text-white md:text-5xl xl:text-6xl">
          <div class="text-xl md:text-3xl">
            <h4 class="leading-snug font-extrabold italic my-4 md:my-8 uppercase z-30">
              Liburan kamu berasa Biasa aja ?
            </h4>
          </div>
          <h4 class="text-xl text-transparent bg-clip-text bg-gradient-to-r from-[#F0BE2E] to-[#FCF086] italic uppercase z-30">
            Spesial Pelajar dan Mahasiswa yang mau Glowup
          </h4>
          <h3 class="text-3xl md:text-5xl leading-snug font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#F0BE2E] to-[#FCF086] italic uppercase z-30">
            HANYA 199K/BULAN
          </h3>
        ...
        <div class="w-full absolutes top-0 bottom-0 right-0">
          {{-- <img class="" src="{{ url('/image/promo/199/Header199_transparan.png')}}" alt="Mis UN"> --}}
        </div>
      </div>
      <div class="md:absolute top-0 bottom-0 right-0 left-0 md:pl-10 -z-10">
        <img class="hidden md:block w-full h-full object-cover object-top" src="{{ url('/image/promo/199/Header199_transparan.png')}}" alt="Mis UN">
        <img class="md:hidden w-full h-full object-cover object-top" src="{{ url('/image/promo/199/Header199.png')}}" alt="Mis UN">
      </div>
    </div>

    
    <div class="mx-auto max-w-5xl text-center px-4 py-8">
      <h2 class="my-4 md:my-6 italic font-extrabold text-xl md:text-4xl">JOIN URBAN ATHLETES, <br/> UPGRADE VERSI TERBAIK DIRIMU</h2>
      <p class="md:text-2xl font-AmpleSoft font-black">Paket Membership Khusus Pelajar dan Mahasiswa, Akses gym premium hanya 199K/Bulan</p>
    </div>

    <div class="w-full relative md:h-[23rem] lg:h-[26rem] bg-black md:bg-transparent overflow-hidden">
      {{-- <div class="md:absolute top-0 bottom-0 right-0 left-0 md:pl-10 md:-z-50 relative overflow-hidden"> --}}
      <div class="md:absolute top-0 bottom-0 right-0 left-0 md:pl-10 md:-z-50 relative overflow-hidden">
        <div class="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-t from-black sm:from-transparent md:max-w-3xl lg:max-w-5xl z-20"></div>
        {{-- <div class="absolute top-0 bottom-0 left-0 right-0 bg-red-500"></div> --}}
        <img class="w-full h-full object-cover scale-110" src="{{ url('/image/promo/199/bg_dapatkan_akses.png')}}" alt="Dapatkan akses">
      </div>
      <div class="
        sm:absolute bottom-0 top-0 left-0 right-100 py-4 md:text-2xl lg:p-12 lg:text-4xl bg-gradient-to-r from-black via-black
        {{-- py-4 md:text-2xl lg:p-12 lg:text-4xl sm:bg-gradient-to-r from-black via-black --}}
        flex items-center h-full
      ">
        <h2 class="max-w-lg lg:max-w-2xl leading-snug font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#F0BE2E] to-[#FCF086] italic uppercase">
          DAPATKAN Akses 
          lebih dari 200 kelas 
  ...
  <div id="tnc-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full inset-0 h-modal h-full pb-4">
    <div class="relative p-4 w-full max-w-4xl h-auto mx-auto">
      <!-- Modal content -->
      <div class="relative bg-white rounded-lg shadow mt-8">
        <!-- Modal body -->
        <div class="p-6 space-y-6 relative">
          ...
          <ol class="list-decimal px-4">
            <li class="py-2">
              Promo 199K ini khusus untuk Pelajar dengan usia antara 17-22 tahun dan dibuktikan dengan menunjukkan kartu pelajar atau kartu mahasiswa.
            </li>
            <li class="py-2">
              Promo ini khusus New Join Member atau ex-member dengan masa aktif kadaluarsa lebih dari 6 bulan, dan tidak bisa diperpanjang dengan promo yang sama.
            </li>
            <li class="py-2">
              Cabang yang dipilih tidak bisa diganti setelah proses registrasi selesai.
            </li>
            <li class="py-2">
