<x-main>
  ...
  <div class="">
    ...
    <div class="container">
      <div class="px-8 md:px-0">
        ...
        <img class="w-full" src="{{ url('/image/benner/kids_holiday.jpg') }}" alt="Urban Athletes Benner">
      </div>
    </div>
  </div>
  ...
  <div class="container my-8">
    ...
    <div class="md:flex justify-center items-center">
      <div class="p-12 w-full md:w-1/2">
        <img class="scale-with-grid" src="{{ url('/image/program/group-exercise.jpg') }}" alt="hm1">
      </div>
      <div class="my-10 px-8 justify-center text-center">
        <p class="mt-14 mb-5 text-center h-auto">
        ...
        <a class="bg-green-ua px-4 py-3 rounded-md border-separate text-white" href="{{ url('/group-exercise') }}" >Cari tahu</a>
      </div>
    </div>
    ...
    <div class="md:flex justify-center items-center">
      ...
      <div class="p-12 w-full md:w-1/2">
        <img class="scale-with-grid" src="{{ url('/image/program/personal-training.jpg') }}" alt="hm1">
      </div>
    </div>
  </div>
