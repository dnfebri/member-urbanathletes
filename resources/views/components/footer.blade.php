<div class="bg-gray-footer text-white">
  ...
  <div class="flex justify-center items-center text-sm py-9 shadow-lg border-y border-gray-500">
    <p>Copyright &copy; <?php echo date("Y"); ?> <a class="text-green-ua" href="#">Urban Athletes</a>. All Rights Reserved.</p>
  </div>
</div>