<div x-data class="antialiased flex justify-start">
    ...
    {{-- <button @click="$store.sidebar.navOpen = !$store.sidebar.navOpen"
        class="sm:hidden absolute top-5 left-5 focus:outline-none z-10">
        <!-- Menu Icons -->
    ...
    <div class="min-h-screen bg-gray-900 transition-all duration-300 space-y-2 fixed sm:relative"
        ...
        <button @click="$store.sidebar.navOpen = !$store.sidebar.navOpen"
            class="sm:hidden absolute top-5 right-5 focus:outline-none z-10">
        ...
        <div class="px-4 space-y-2">
            ...
            <div x-data="dropdown" class="relative">
                ...
                <!-- Dropdown content -->
                <div x-cloak x-show="open" @click.outside="open=false"
                    x-bind:class="$store.sidebar.full ? expandedClass : shrinkedClass" class="text-gray-400 space-y-0">
                    <h1 class="hover:text-gray-200 cursor-pointer">Item 1</h1>
                    <h1 class="hover:text-gray-200 cursor-pointer">Item 2</h1>
                    <!-- Sub Dropdown  -->
