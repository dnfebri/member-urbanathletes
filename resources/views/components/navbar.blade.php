...
<nav id="navbar" class="bg-transparent absolute top-0 left-0 w-full flex items-center z-10">
  <div class="container">
    <div class="flex items-center justify-between relative">
      <div class="px-4">
        <a href="#" class="font-bold text-lg text-blue-700 block py-6">Logo</a>
      </div>
      <div class="flex items-center px-4">
        ...
        <div id="nav-menu" class="hidden absolute py-5 bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-green-ua lg:max-w-full lg:shadow-none lg:rounded-none">
          <ul class="block lg:flex">
            <li class="group"><a href="#" class="text-base text-black py-2 mx-8 flex group-hover:text-yellow-500">Home</a></li>
            <li class="group"><a href="#" class="text-base text-black py-2 mx-8 flex group-hover:text-yellow-500">Abaut</a></li>
            <li class="group"><a href="#" class="text-base text-black py-2 mx-8 flex group-hover:text-yellow-500">Programs</a></li>
            <li class="group"><a href="#" class="text-base text-black py-2 mx-8 flex group-hover:text-yellow-500">What's on</a></li>
            <li class="group"><a href="#" class="text-base text-black py-2 mx-8 flex group-hover:text-yellow-500">Success Story</a></li>
            <li class="group"><a href="#" class="text-base text-black py-2 mx-8 flex group-hover:text-yellow-500">Articles</a></li>
            <li class="group"><a href="#" class="text-base text-black py-2 mx-8 flex group-hover:text-yellow-500">Member</a></li>
          </ul>
        </div>
      </div>
    </div>
